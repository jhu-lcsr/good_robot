...
class Robot(object):
    def __init__(self, is_sim, obj_mesh_dir, num_obj, workspace_limits,
        ...
        if self.is_sim:
            ...
            self.obj_mesh_color = self.color_space[np.asarray(
                range(self.num_obj)) % 10, :]
            ...
            if self.is_testing and self.test_preset_cases:
                ...
                for object_idx in range(self.num_obj):
                    ...
                    self.test_obj_mesh_files.append(os.path.join(
                        self.obj_mesh_dir, file_content_curr_object[0]))
    ...
    def setup_sim_camera(self):
        ...
        self.cam_intrinsics = np.asarray(
            [[618.62, 0, 320], [0, 618.62, 240], [0, 0, 1]])
    ...
    def add_objects(self):
        ...
        for object_idx in range(len(self.obj_mesh_ind)):
            ...
            drop_x = (self.workspace_limits[0][1] - self.workspace_limits[0][0] -
                      0.2) * np.random.random_sample() + self.workspace_limits[0][0] + 0.1
            drop_y = (self.workspace_limits[1][1] - self.workspace_limits[1][0] -
                      0.2) * np.random.random_sample() + self.workspace_limits[1][0] + 0.1
            ...
            if self.is_testing and self.test_preset_cases:
                object_position = [self.test_obj_positions[object_idx][0],
                                   self.test_obj_positions[object_idx][1], self.test_obj_positions[object_idx][2]]
    ...
    def grasp(self, position, heightmap_rotation_angle, workspace_limits):
        ...
        if self.is_sim:
            ...
            location_above_grasp_target = (
                position[0], position[1], position[2] + grasp_location_margin)
