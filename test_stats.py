...
if __name__ == '__main__':
    ...
    print('action efficiency with 6 action per trial optimum: ' + str((6.*num_trials)/clearance_log[num_trials][0]) + ' action efficiency with 4 action per trial optimum: ' + str((4.*num_trials)/clearance_log[num_trials][0]))
    print('data dir: ' + str(args.data_dir))
