...
# source: https://github.com/jhu-lcsr/costar_plan/blob/d469d62d72cd405ed07b10c62eb24391c0af1975/costar_hyper/vrep/visualization.py
"""
import os
import errno
import traceback
...
flags.DEFINE_string('vrepVisualizeDepthFormat', 'vrep_depth_encoded_rgb',
                       ...
                       """)
flags.DEFINE_string('vrepVisualizeRGBFormat', 'vrep_rgb',
                       """  Controls how images are displayed. Options are:
                        ...
                        'vrep': add a vrep prefix to any of the above commands to
                            ...
                            see http://www.forum.coppeliarobotics.com/viewtopic.php?f=9&t=737&p=27805#p27805.
                       """)
flags.DEFINE_string('vrepDebugMode', 'save_ply,print_transform',
